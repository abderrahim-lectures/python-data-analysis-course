...
<span class="gamified-flourish">🧮 Vous connaissez déjà $f(x)$. Cette semaine, vous apprenez à écrire votre propre $f$.</span>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>def is_even(n): return n % 2 == 0</code> — le corps de la fonction est exactement le même test de divisibilité que vous connaissez déjà, encapsulé pour être réutilisable.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>def average(numbers): return sum(numbers) / len(numbers)</code>. L'appeler avec une liste vide lève une <code>ZeroDivisionError</code> — à noter, même si la gérer élégamment est la matière bonus de la semaine prochaine.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Définissez <code>def is_prime(n): ...</code> en réutilisant la boucle de primalité de la semaine dernière à l'intérieur du corps de la fonction, puis appelez-la dans une compréhension : <code>[n for n in range(2, 50) if is_prime(n)]</code>.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> def f(x, y=1): return x + y — l'appel f(5) utilise la valeur par défaut (6), f(5, 10) la remplace (15).</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> def fibonacci(n): if n &lt;= 1: return n; return fibonacci(n - 1) + fibonacci(n - 2) — reflète directement la définition mathématique F(n) = F(n-1) + F(n-2), avec F(0)=0 et F(1)=1 comme deux cas de base.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> def stats(numbers): return min(numbers), max(numbers), sum(numbers) / len(numbers) — renvoie un tuple à 3 éléments, dépaqueté au moment de l'appel sous la forme lo, hi, avg = stats(numbers).</p>
...
<div class="quiz" data-quiz="python-101-normal-week-4">
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">1. Que renvoie une fonction si elle n'a pas d'instruction return explicite ?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">0</button>
        <button class="quiz-q__opt" data-idx="1">Une chaîne vide</button>
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">2. Dans def greet(name, greeting=&quot;Hello&quot;), que représente &quot;Hello&quot; ?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Un argument obligatoire</button>
        <button class="quiz-q__opt" data-idx="1">Une valeur par défaut utilisée quand greeting n'est pas fourni</button>
        <button class="quiz-q__opt" data-idx="2">Une variable globale</button>
        <button class="quiz-q__opt" data-idx="3">Une valeur de retour</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">3. Une variable créée à l'intérieur d'une fonction est, par défaut :</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Globale</button>
        <button class="quiz-q__opt" data-idx="1">Locale à cette fonction</button>
        <button class="quiz-q__opt" data-idx="2">Partagée entre toutes les fonctions</button>
        <button class="quiz-q__opt" data-idx="3">Une constante</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">4. Qu'utilise greet(name=&quot;Sara&quot;) pour passer l'argument ?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Un argument positionnel</button>
        <button class="quiz-q__opt" data-idx="1">Un paramètre par défaut</button>
        <button class="quiz-q__opt" data-idx="2">Un argument nommé (keyword argument)</button>
        <button class="quiz-q__opt" data-idx="3">La portée globale</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">5. Toute fonction récursive doit avoir :</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Une boucle for à l'intérieur</button>
        <button class="quiz-q__opt" data-idx="1">Un cas de base qui arrête la récursivité</button>
        <button class="quiz-q__opt" data-idx="2">Un paramètre par défaut</button>
        <button class="quiz-q__opt" data-idx="3">Une docstring</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
