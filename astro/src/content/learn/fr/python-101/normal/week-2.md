...
<span class="gamified-flourish">🔀 Cette semaine, vos programmes arrêtent d'exécuter les trois mêmes lignes à chaque fois et commencent à prendre des décisions.</span>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Utilisez une boucle <code>for</code> sur <code>range(1, 11)</code>, et à l'intérieur une chaîne <code>if/elif/else</code> vérifiant la divisibilité par 15, puis par 3, puis par 5, avec un <code>else</code> final qui affiche le nombre lui-même.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Une boucle <code>while</code> qui continue d'appeler <code>input()</code> et de vérifier <code>== "quit"</code> pour décider si elle doit exécuter <code>break</code>, car vous ne savez pas à l'avance combien de fois l'étudiant répondra.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Bouclez sur <code>range(2, n)</code> et vérifiez si <code>n % i == 0</code> pour l'un d'eux à l'aide d'un drapeau ou de <code>break</code> ; si aucun diviseur n'est trouvé, <code>n</code> est premier. C'est exactement la définition de la primalité « pour tout i de 2 à n-1, n modulo i n'est pas 0 » écrite sous forme de code.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> if 18 &lt;= age &lt; 65 and has_ticket: ... — en combinant la comparaison chaînée de la Semaine 1 avec and, ce qui reflète exactement 18 ≤ age {"<"} 65.</p>
...
<div class="quiz" data-quiz="python-101-normal-week-2">
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">1. Que produit range(5) ?</p>
      ...
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">2. Quelle instruction quitte immédiatement la boucle englobante la plus proche ?</p>
        <div class="quiz-q__options">
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">3. Qu'est-ce qui détermine quelles lignes appartiennent à un bloc if en Python ?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Les accolades {}</button>
        <button class="quiz-q__opt" data-idx="1">L'indentation</button>
        <button class="quiz-q__opt" data-idx="2">Les points-virgules</button>
        <button class="quiz-q__opt" data-idx="3">Les parenthèses</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">4. Une boucle while dont la condition ne devient jamais False va :</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Lever immédiatement une SyntaxError</button>
        <button class="quiz-q__opt" data-idx="1">S'exécuter une fois puis s'arrêter</button>
        <button class="quiz-q__opt" data-idx="2">Boucler indéfiniment (boucle infinie)</button>
        <button class="quiz-q__opt" data-idx="3">Être automatiquement convertie en boucle for</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">5. Dans &quot;a and b&quot;, si a s'évalue à False, que se passe-t-il pour b ?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Il est quand même évalué, mais ignoré</button>
        <button class="quiz-q__opt" data-idx="1">Il n'est jamais évalué (évaluation en court-circuit)</button>
        <button class="quiz-q__opt" data-idx="2">Il lève une SyntaxError</button>
        <button class="quiz-q__opt" data-idx="3">Il est évalué en premier, avant a</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
