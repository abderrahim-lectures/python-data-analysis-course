...
<span class="gamified-flourish">🔀 Esta semana tus programas dejan de ejecutar siempre las mismas tres líneas y empiezan a tomar decisiones.</span>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Usa un bucle <code>for</code> sobre <code>range(1, 11)</code>, y dentro una cadena <code>if/elif/else</code> que compruebe la divisibilidad entre 15, luego 3, luego 5, con un <code>else</code> final que imprima el número mismo.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Un bucle <code>while</code> que siga llamando a <code>input()</code> y comprobando <code>== "quit"</code> para decidir si hace <code>break</code>, ya que no sabes de antemano cuántas veces responderá el estudiante.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Inicializa <code>total = 0</code>, itera con <code>for i in range(1, 101)</code>, suma <code>i</code> a <code>total</code> en cada paso, y luego imprímelo. La fórmula de suma en forma cerrada n(n+1)/2 con n=100 da 5050, lo que te permite verificar la respuesta del bucle sin volver a ejecutarlo.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Itera sobre <code>range(2, n)</code> y comprueba si <code>n % i == 0</code> para alguno de ellos usando una bandera o <code>break</code>; si no se encuentra ningún divisor, <code>n</code> es primo. Esta es la misma definición de primalidad "para todo i desde 2 hasta n-1, n mod i no es 0" escrita como código.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> if 18 &lt;= age &lt; 65 and has_ticket: ... — combina la comparación encadenada de la Semana 1 con and, reflejando exactamente 18 ≤ age {"<"} 65.</p>
...
<div class="quiz" data-quiz="python-101-normal-week-2">
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">1. ¿Qué produce range(5)?</p>
      ...
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">2. ¿Qué sentencia sale inmediatamente del bucle más cercano que la contiene?</p>
        <div class="quiz-q__options">
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">3. ¿Qué determina qué líneas pertenecen a un bloque if en Python?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Llaves {}</button>
        <button class="quiz-q__opt" data-idx="1">La indentación</button>
        <button class="quiz-q__opt" data-idx="2">Los punto y coma</button>
        <button class="quiz-q__opt" data-idx="3">Los paréntesis</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">4. Un bucle while con una condición que nunca se vuelve False:</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Lanza un SyntaxError inmediatamente</button>
        <button class="quiz-q__opt" data-idx="1">Se ejecuta una vez y se detiene</button>
        <button class="quiz-q__opt" data-idx="2">Se repite para siempre (bucle infinito)</button>
        <button class="quiz-q__opt" data-idx="3">Se convierte automáticamente en un bucle for</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">5. En &quot;a and b&quot;, si a se evalúa como False, ¿qué pasa con b?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Se evalúa igualmente, pero se ignora</button>
        <button class="quiz-q__opt" data-idx="1">Nunca se evalúa (cortocircuito)</button>
        <button class="quiz-q__opt" data-idx="2">Lanza un SyntaxError</button>
        <button class="quiz-q__opt" data-idx="3">Se evalúa primero, antes que a</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
