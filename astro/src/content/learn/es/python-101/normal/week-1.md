...
<span class="gamified-flourish">🐍 Todo lenguaje empieza nombrando cosas. Esta semana aprenderás la versión de Python de "sea $x$...".</span>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>type(7 / 2)</code> es <code>float</code> — la división real (<code>/</code>) siempre produce un float en Python 3, incluso cuando ambos operandos son int y el resultado es un número entero.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Sí: <code>"3" + "4"</code> es el string <code>"34"</code> (concatenación), no <code>7</code>. Sumar un <code>str</code> y un <code>int</code> directamente (<code>"3" + 4</code>) lanza un <code>TypeError</code> — debes convertir primero.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Escribe un pequeño programa: lee un nombre y un año de nacimiento con dos llamadas a <code>input()</code>, convierte el año a <code>int</code>, réstalo del año actual, e imprime una frase usando un f-string, por ejemplo <code>{"f\"{name}, you are about {age} years old.\""}</code>.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> 15 // 4 es 3 (piso de 3.75), y 15 % 4 es 3 (ya que 15 = 4·3 + 3). Juntos satisfacen 15 = 4·(15 // 4) + (15 % 4), la misma identidad del algoritmo de la división que conoces de teoría de números.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> int(-7.9) es -7 (trunca hacia cero — elimina la parte decimal), mientras que -7.9 // 1 es -8.0 (redondea hacia abajo, hacia menos infinito). Coinciden para números positivos pero difieren para los negativos, que es exactamente el error del que advierte la sección "Errores comunes" de arriba.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Extiende la calculadora de propina: lee una tercera entrada con el número de personas, conviértela a <code>int</code>, y divide <code>total</code> entre ese número para obtener <code>per_person</code>, impreso con formato <code>:.2f</code> como los demás montos.</p>
...
<div class="quiz" data-quiz="python-101-normal-week-1">
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">1. ¿Cuál es el tipo del resultado de 7 / 2 en Python 3?</p>
      ...
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">2. ¿Qué devuelve siempre input(), sin importar lo que escriba el usuario?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">int</button>
        <button class="quiz-q__opt" data-idx="1">float</button>
        <button class="quiz-q__opt" data-idx="2">str</button>
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">3. ¿Cuál es el resultado de 17 % 5?</p>
        <div class="quiz-q__options">
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">4. ¿Qué operador prueba igualdad (y no asignación)?</p>
        <div class="quiz-q__options">
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">5. ¿Cuál es el resultado de int(4.9)?</p>
        <div class="quiz-q__options">
        ...
        <button class="quiz-q__opt" data-idx="3">Un TypeError</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
