  ...
  projects={mergeProjectMeta([
    {
      ...
      summary:
        "Answer 'where is X defined?' with an exact ast-based symbol index and 'how does X work?' with embedding search, grounding a free-tier LLM in file-and-line citations.",
    },
    {
