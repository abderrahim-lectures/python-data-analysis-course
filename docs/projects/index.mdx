  ...
  projects={mergeProjectMeta([
    {
      ...
      summary:
        "Clone a real repository, chunk its code and docs with line tracking, embed them locally, and ask questions that come back with file-and-line citations you can verify.",
    },
    {
