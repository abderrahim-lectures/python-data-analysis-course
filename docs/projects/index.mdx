  ...
  projects={mergeProjectMeta([
    {
      ...
      title: 'Turn a Folder of PDFs, Configs, and SQL Schemas Into a Knowledge Graph',
      summary:
        'Walk a folder of mixed PDFs, config files, and SQL schemas, extract the references between them with pypdf and the standard library, and build a queryable knowledge graph — no API key, no LLM.',
    },
    {
