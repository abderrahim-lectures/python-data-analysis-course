...
افتح رابط مجموعة البيانات أعلاه، انسخ محتواها، ثم في Trinket أنشئ ملفًا باسم `slm-corpus.csv` والصقه فيه، تمامًا مثل الأسبوع 5 من المسار العادي لبايثون 101.
:::
