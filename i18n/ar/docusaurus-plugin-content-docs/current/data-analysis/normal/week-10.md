...
**🎉 أنهيت مسار Pandas وتحليل البيانات العادي — والدورة كاملة، إن أخذت المسار العادي في كلا القسمين.** توجّه إلى [تقدّمي](/progress) لرؤية أوسمتك، وإن أنهيت كل أسبوع، افتح [مشاريع المشروع الختامي](/docs/bonus): تثبيت بايثون فعليًا وبناء أول وكيل ذكاء اصطناعي خاص بك.
