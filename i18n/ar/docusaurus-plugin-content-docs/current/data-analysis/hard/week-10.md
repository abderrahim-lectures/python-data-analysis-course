...
**🎉 لقد أكملت المسار الصعب لتحليل البيانات بـ Pandas — والدورة بأكملها، إذا اخترت الصعب/الصعب أو أي تركيبة عبر القسمين.** توجّه إلى [تقدمي](/progress) لرؤية أوسمتك، وإذا أنهيت كل أسبوع، افتح [مشاريع المشروع الختامي](/docs/bonus): تثبيت Python فعليًا وبناء أول وكيل ذكاء اصطناعي خاص بك.
