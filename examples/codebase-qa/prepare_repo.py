"""Walks a repo, collects indexable files, and splits them into chunks
that remember their source file and line range.

This is the same code-aware chunker used by the RAG Over a GitHub Repo
example -- code files split at function/class boundaries, prose files at
paragraph boundaries.

Run with: uv run python prepare_repo.py /path/to/repo
Imported by build_index.py.
"""
