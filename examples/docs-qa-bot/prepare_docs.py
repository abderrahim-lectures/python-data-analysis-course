...
file and does the actual embedding. Identical approach to prepare_notes.py
in the course's rag-notes example -- a Discord bot's docs folder is chunked
exactly the same way a personal notes folder is.
"""
...
def load_chunks() -> list[dict]:
    ...
    across every .md/.txt file in DOCS_DIR."""
    chunks = []
