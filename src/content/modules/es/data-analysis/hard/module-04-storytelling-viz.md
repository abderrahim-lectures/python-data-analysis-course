...
- **Recompensa de XP**: +150 XP por lección (bono del track avanzado)
...
- **Progreso**: Completa ambas lecciones para desbloquear el capstone del Módulo 5
- **Bono de racha**: Completa los Módulos 1 a 4 en secuencia para un bono de +20 XP
