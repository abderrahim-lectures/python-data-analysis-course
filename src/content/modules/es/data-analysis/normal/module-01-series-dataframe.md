...
- **Progreso**: Completa ambas lecciones para desbloquear el Módulo 02 (Selección, Filtrado e Indexación)
- **Bono de racha**: Completa este módulo como el primero del track de Análisis de Datos para un bono de +10 XP
