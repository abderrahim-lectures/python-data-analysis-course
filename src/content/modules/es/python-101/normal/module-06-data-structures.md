...
| Lección | Reto | XP |
|---------|------|----|
| Listas y tuplas | Construir una lista de tareas con append, remove, sort y empaquetado de tuplas | +60 |
| Dicts y conjuntos | Crear un contador de frecuencia de palabras con dicts y encontrar palabras únicas con conjuntos | +60 |
| Comprensiones | Reescribir 3 bucles for como comprensiones de lista/dict/set | +60 |
