...
- **Progreso**: completa las 2 lecciones para completar la pista normal de Python 101
...
| Lección | Reto | XP |
|---------|------|----|
| Lectura y escritura | Leer un archivo de texto, contar líneas/palabras/caracteres y escribir un resumen | +100 |
| CSV y pathlib | Analizar un archivo CSV, filtrar filas por una condición y guardar el resultado | +100 |
