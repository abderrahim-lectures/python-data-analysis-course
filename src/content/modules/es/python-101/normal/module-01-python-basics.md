...
- **Recompensa de XP**: +60 XP por lección completada (240 XP en total para este módulo)
- **Retos**: cada lección incluye retos de codificación interactivos en el playground del navegador
- **Progreso**: completa las 4 lecciones para terminar este módulo
...
| Lección | Reto | XP |
|---------|------|----|
| Imprimir | Mostrar un mensaje de bienvenida formateado con varias llamadas a `print()` | +60 |
| Variables | Almacenar 5 valores diferentes y reasignar dos de ellos | +60 |
| Tipos | Identificar el tipo de 10 valores diferentes sin ejecutar código | +60 |
| Conversión de tipos | Convertir la entrada de texto de una persona usuaria en un número y calcular un resultado | +60 |
