...
- **Progreso**: completa las 3 lecciones para desbloquear el Módulo 03 (Flujo de control)
...
| Lección | Reto | XP |
|---------|------|----|
| Aritmética | Construir una calculadora de propinas usando división de piso y módulo | +100 |
| Comparación | Encadenar 3 comparaciones para validar el formato de un número de teléfono | +100 |
| Lógica booleana | Combinar 4 condiciones con and/or/not para modelar una regla de juego | +100 |
