...
- **Progreso**: completa las 3 lecciones para desbloquear el Módulo 04 (Funciones)
...
| Lección | Reto | XP |
|---------|------|----|
| Condicionales | Construir un clasificador de niveles (bronce/plata/oro) según rangos de puntuación | +100 |
| Bucles for | Iterar sobre una lista de nombres e imprimir un saludo para cada uno | +100 |
| Bucles while | Crear un bucle de adivinanza de números que salga con la respuesta correcta | +100 |
