...
- **Progreso**: completa las 2 lecciones para desbloquear el Módulo 06 (Estructuras de datos)
...
| Lección | Reto | XP |
|---------|------|----|
| Métodos de cadenas | Limpiar una fila CSV desordenada eliminando, dividiendo y reuniendo | +100 |
| Segmentado y formateo | Extraer las iniciales de un nombre y formatear un recibo con f-strings | +100 |
