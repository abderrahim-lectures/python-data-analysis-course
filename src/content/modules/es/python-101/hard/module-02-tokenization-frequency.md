...
- **Progreso**: completa ambas lecciones para desbloquear el módulo de tablas de bigramas
- **Bono por racha**: completa este módulo después del Módulo 1 para un bono de +15 XP
