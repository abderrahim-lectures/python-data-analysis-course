...
- **Progression** : Terminez les 2 leçons pour compléter la piste Python 101 Standard
...
| Leçon | Défi | XP |
|--------|-----------|-----|
| Lecture et écriture | Lisez un fichier texte, comptez les lignes/mots/caractères et écrivez un résumé | +100 |
| CSV et pathlib | Analysez un fichier CSV, filtrez les lignes selon une condition et enregistrez le résultat | +100 |
