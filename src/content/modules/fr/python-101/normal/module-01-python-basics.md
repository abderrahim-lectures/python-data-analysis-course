...
- **Récompense XP** : +60 XP par leçon terminée (240 XP au total pour ce module)
- **Défis** : Chaque leçon inclut des défis de codage interactifs dans le terrain de jeu du navigateur
- **Progression** : terminez les 4 leçons pour terminer ce module
...
| Leçon | Défi | XP |
|--------|-----------|-----|
| Impression | Affichez un message de bienvenue formaté avec plusieurs appels `print()` | +60 |
| Variables | Stockez 5 valeurs différentes et réaffectez deux d'entre elles | +60 |
| Types | Identifiez le type de 10 valeurs différentes sans exécuter le code | +60 |
| Conversion de types | Convertissez l'entrée texte d'un utilisateur en nombre et calculez un résultat | +60 |
