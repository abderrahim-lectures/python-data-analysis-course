...
- **Progression** : Terminez les 3 leçons pour débloquer le Module 05 (Les chaînes en profondeur)
...
| Leçon | Défi | XP |
|--------|-----------|-----|
| Définir des fonctions | Écrivez une fonction qui convertit des degrés Celsius en Fahrenheit et appelez-la 3 fois | +100 |
| Paramètres | Créez une fonction avec des paramètres par défaut, par mot-clé et *args | +100 |
| Portée et Lambda | Corrigez un bogue de portée dans un code donné, puis remplacez une ligne unique par une lambda | +100 |
