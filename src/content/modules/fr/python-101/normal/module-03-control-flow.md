...
- **Progression** : Terminez les 3 leçons pour débloquer le Module 04 (Fonctions)
...
| Leçon | Défi | XP |
|--------|-----------|-----|
| Conditionnelles | Construisez un classifieur de niveaux (bronze/argent/or) basé sur les intervalles de score | +100 |
| Boucles for | Itérez sur une liste de noms et affichez un salut pour chacun | +100 |
| Boucles while | Créez une boucle de devinette de nombre qui sort sur la bonne réponse | +100 |
