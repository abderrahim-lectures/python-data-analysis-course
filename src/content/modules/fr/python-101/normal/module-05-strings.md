...
| Leçon | Défi | XP |
|--------|-----------|-----|
| Méthodes de chaîne | Nettoyez une ligne CSV brouillonne en retirant, découpant et réassemblant | +60 |
| Découpage et formatage | Extrayez les initiales d'un nom et formatez un reçu avec des f-strings | +60 |
