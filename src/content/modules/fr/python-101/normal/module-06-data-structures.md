...
| Leçon | Défi | XP |
|--------|-----------|-----|
| Listes et tuples | Construisez une liste de tâches avec append, remove, sort et l'empaquetage de tuple | +60 |
| Dicts et ensembles | Créez un compteur de fréquence de mots avec des dicts et trouvez des mots uniques avec des ensembles | +60 |
| Compréhensions | Réécrivez 3 boucles for comme compréhensions de liste/dict/ensemble | +60 |
