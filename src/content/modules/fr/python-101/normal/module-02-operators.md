...
- **Progression** : Terminez les 3 leçons pour débloquer le Module 03 (Le contrôle de flux)
...
| Leçon | Défi | XP |
|--------|-----------|-----|
| Arithmétique | Construisez une calculatrice de pourboire avec la division entière et le modulo | +100 |
| Comparaison | Enchaînez 3 comparaisons pour valider un format de numéro de téléphone | +100 |
| Logique booléenne | Combinez 4 conditions avec et/ou/non pour modéliser une règle de jeu | +100 |
