...
- **Progression** : Terminez les deux leçons pour débloquer le module de tokenisation
- **Bonus de série** : Terminez ce module en premier dans la séquence pour un bonus de +15 XP
