...
- **Récompense XP** : +150 XP par leçon terminée (300 XP au total pour ce module de synthèse)
...
- **Progression** : terminez les deux leçons pour gagner le badge de fin du parcours Data Analysis Normal
- **Bonus de série** : terminez ce module immédiatement après le Module 04 pour un bonus de série de +10 XP
