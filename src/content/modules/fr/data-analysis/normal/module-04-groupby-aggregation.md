...
- **Progression** : terminez les deux leçons pour débloquer le Module 05 (EDA guidée du Titanic)
- **Bonus de série** : terminez ce module immédiatement après le Module 03 pour un bonus de série de +10 XP
