...
- **Progression** : terminez les deux leçons pour débloquer le Module 02 (Sélection, Filtrage & Indexation)
- **Bonus de série** : terminez ce module en premier dans le parcours Data Analysis pour un bonus de +10 XP
