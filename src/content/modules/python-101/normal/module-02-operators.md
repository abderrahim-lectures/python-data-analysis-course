...
- **Progress**: Complete all 3 lessons to unlock Module 03 (Control Flow)
- **Streak Bonus**: Complete this module in one sitting for +10 XP bonus
- **Achievement Unlocked**: "Expression Engine" — write a chain of 5 operators in a single expression

### Lesson Challenges

| Lesson | Challenge | XP |
|--------|-----------|-----|
| Arithmetic | Build a tip calculator using floor division and modulo | +100 |
| Comparison | Chain 3 comparisons to validate a phone number format | +100 |
| Boolean Logic | Combine 4 conditions with and/or/not to model a game rule | +100 |
