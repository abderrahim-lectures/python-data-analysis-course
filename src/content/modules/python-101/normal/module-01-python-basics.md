...
- **XP Reward**: +60 XP per lesson completed (240 XP total for this module)
- **Challenges**: Each lesson includes interactive coding challenges in the browser playground
- **Progress**: Complete all 4 lessons to finish this module
...
| Lesson | Challenge | XP |
|--------|-----------|-----|
| Printing | Output a formatted welcome message with multiple `print()` calls | +60 |
| Variables | Store 5 different values and reassign two of them | +60 |
| Types | Identify the type of 10 different values without running code | +60 |
| Type Conversion | Convert a user's text input into a number and compute a result | +60 |
