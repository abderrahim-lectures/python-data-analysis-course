...
| Lesson | Challenge | XP |
|--------|-----------|-----|
| Defining Functions | Write a function that converts Celsius to Fahrenheit and call it 3 times | +60 |
| Parameters | Create a function with default, keyword, and *args parameters | +60 |
| Scope & Lambda | Fix a scope bug in given code, then replace a one-liner with a lambda | +60 |
