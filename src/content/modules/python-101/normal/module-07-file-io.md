...
| Lesson | Challenge | XP |
|--------|-----------|-----|
| Reading & Writing | Read a text file, count lines/words/characters, and write a summary | +60 |
| CSV & Pathlib | Parse a CSV file, filter rows by a condition, and save the result | +60 |
