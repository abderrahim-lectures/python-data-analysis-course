...
- **Progress**: Complete all 2 lessons to unlock Module 06 (Data Structures)
- **Streak Bonus**: Complete this module in one sitting for +10 XP bonus
- **Achievement Unlocked**: "String Wizard" — reverse a string using slicing in one expression

### Lesson Challenges

| Lesson | Challenge | XP |
|--------|-----------|-----|
| String Methods | Clean a messy CSV row by stripping, splitting, and rejoining | +100 |
| Slicing & Formatting | Extract initials from a name and format a receipt with f-strings | +100 |
