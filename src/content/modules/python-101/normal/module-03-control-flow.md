...
| Lesson | Challenge | XP |
|--------|-----------|-----|
| Conditionals | Build a tier classifier (bronze/silver/gold) based on score ranges | +60 |
| For Loops | Iterate over a list of names and print a greeting for each | +60 |
| While Loops | Create a number-guessing loop that exits on the correct answer | +60 |
