...
- **Progress**: Complete all 3 lessons to unlock Module 07 (File I/O)
- **Streak Bonus**: Complete this module in one sitting for +10 XP bonus
- **Achievement Unlocked**: "Data Organizer" — use all four data structures in a single program

### Lesson Challenges

| Lesson | Challenge | XP |
|--------|-----------|-----|
| Lists & Tuples | Build a to-do list with append, remove, sort, and tuple packing | +100 |
| Dicts & Sets | Create a word frequency counter using dicts and find unique words with sets | +100 |
| Comprehensions | Rewrite 3 for-loops as list/dict/set comprehensions | +100 |
