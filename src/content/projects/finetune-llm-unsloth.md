...
### 1.1 Write and save the examples
...
### 1.2 Verify the file and grow it to a real dataset
...
### 2.1 Run the stock notebook once, unmodified
...
### 2.2 Swap in your own dataset and download the adapter
...
### 3.1 Write the inference script
...
### 3.2 Verify the fine-tuned behavior shows up
