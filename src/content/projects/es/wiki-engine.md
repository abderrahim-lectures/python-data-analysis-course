...
learningObjectives:
  - Almacenar páginas de wiki como archivos Markdown con un esquema de nombres por slug
  - Leer y mostrar páginas en HTML con un pequeño renderizador Markdown-lite
  - Mantener un historial de versiones de solo añadido y diferenciar dos versiones cualesquiera
  - Escanear [[links]] para calcular un índice inverso de backlinks
  - Tokenizar y clasificar búsquedas de texto completo por frecuencia de término
prerequisites:
  - "Fundamentos de Python (funciones, diccionarios, E/S de archivos)"
  - "Cómodo con regex básico (findall, sub)"
  - "Uso de rutas pathlib para leer y listar archivos"
---
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/abderrahim-lectures/python-data-analysis-course/main?filepath=examples%2Fwiki-engine%2Fnotebook.es.ipynb)
