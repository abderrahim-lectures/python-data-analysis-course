...
يفترض هذا أساسيات Python وأساسيات HTML ومكتبة `requests` (المغطاة في الإعداد) — لا شيء من تحليل البيانات مطلوب. إنه اختياري وغير مصنّف؛ راجع [المشاريع الواقعية](/docs/projects) للقائمة الكاملة والمتنامية.
