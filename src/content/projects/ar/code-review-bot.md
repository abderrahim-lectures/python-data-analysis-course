...
هذا يفترض إلمامًا بالدوال والمجموعات وإدخال/إخراج الملفات وJSON. إنه مشروع اختياري غير مُقيَّم — راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة والنامية.
