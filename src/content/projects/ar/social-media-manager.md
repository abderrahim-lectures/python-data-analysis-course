...
يفترض هذا أساسيات بايثون وارتياحًا مع `groupby` في pandas — لا شيء أبعد من ذلك من تحليل البيانات مطلوب. المشروع اختياري وغير مُقيَّم؛ راجع [المشاريع الواقعية](/docs/projects) للقائمة الكاملة المتزايدة.
