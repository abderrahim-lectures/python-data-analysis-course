...
### 1.4 ثم أعدّ مشروعًا وثبّت حزمة MCP الرسمية لـ Python، بإضافتها الاختيارية `cli` (هذا ما يمنحك أم...
...
### 2.1 واجهة الحزمة عالية المستوى، `FastMCP`، تحوّل دالة Python عادية إلى أداة MCP بمزخرِف (decorat...
...
### 3.1 قبل ربط هذا بأي عميل ذكاء اصطناعي حقيقي، شغّله بمفرده وتأكد أن الأدوات تعمل فعلاً. تشحن الحز...
...
### 3.2 يبدأ هذا خادمك ويفتح **MCP Inspector** — أداة مجانية قائمة على المتصفح تتيح لك استدعاء `sear...
...
### 4.1 يدعم مستوى [Claude Desktop](https://claude.ai/download) المجاني الاتصال بخوادم MCP محلية. يق...
