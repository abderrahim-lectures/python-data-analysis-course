...
هذا يفترض إنهاء Python 101 — القوائم، القواميس، الحلقات، الدوال — مع إلمام مريح بقراءة `csv`. لا شيء هنا يحتاج pandas. هذا اختياري وغير مُقيَّم؛ راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة والنامية.
