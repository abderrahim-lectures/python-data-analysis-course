...
يفترض هذا ما يعادل بايثون 101 إضافةً إلى الراحة مع `re` و`pathlib`. لا شيء من وحدة تحليل البيانات مطلوب. هذا المشروع اختياري وغير مقيَّم؛ راجع [المشاريع الواقعية](/ar/مشاريع) للقائمة الكاملة المتزايدة.
