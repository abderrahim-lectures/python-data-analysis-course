...
هذا يفترض أساسيات Python وارتياحًا مع pandas من تحليل البيانات — لا شيء أبعد من ذلك. المشروع اختياري وغير مُقيَّم؛ راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة.
