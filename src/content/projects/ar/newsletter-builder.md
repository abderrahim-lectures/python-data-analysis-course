...
يفترض هذا إنهاء Python 101 وارتياحـًا مع الدوال والقواميس والقوائم — ستقابل pandas في خطوة واحدة، لكن لا شيء أبعد من ذلك مطلوب. هذا اختياري وغير مُقيَّم؛ راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة المتنامية.
