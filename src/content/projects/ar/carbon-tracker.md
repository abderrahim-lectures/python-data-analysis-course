...
هذا يفترض قوائم وقواميس Python وحلقات `for` واستخدامًا أساسيًا للطرفية. إنه مشروع اختياري غير مُقيَّم — راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة والنامية. كل قطعة تعمل على تركيب Python أساسي (3.10+).
