...
هذا يفترض عملًا أساسيًا بالبيانات المرتبة (tidy data) ولا شيء منه مُقيَّم؛ هذا المشروع اختياري وغير مُقيَّم — راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة والنامية.
