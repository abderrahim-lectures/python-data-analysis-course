...
learningObjectives:
  - ولّد سلسلة زمنية مفهرسة بالتاريخ وشكّلها باستخدام pandas
  - "فكّك السلسلة إلى اتجاه وموسمية وباقٍ"
  - "توقّع المستقبل بنموذج اتجاه + موسمية"
  - قيّم خطأ التوقع بالاختبار الرجعي
  - اكتشف الشذوذ واربط سلسلتين في رسم بياني
prerequisites:
