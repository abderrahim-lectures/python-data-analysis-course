...
يفترض هذا معرفة Python للمبتدئين والراحة في التعامل مع القواميس والقوائم — لا يلزم شيء من تحليل البيانات. إنه اختياري وغير مقيم؛ انظر [مشاريع واقعية](/docs/projects) للقائمة الكاملة المتزايدة.
