...
هذا يفترض معرفة القواميس المتداخلة والمجموعات وفهم القوائم وأساسيات JSON. المشروع اختياري وغير مُقيَّم — راجع [مشاريع من العالم الحقيقي](/docs/projects) للقائمة الكاملة المتنامية. ملف واحد، مكتبة قياسية فقط.
