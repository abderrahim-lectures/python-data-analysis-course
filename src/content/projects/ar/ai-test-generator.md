...
هذا يفترض إتقان القيم الافتراضية للدوال وفهمًا سليمًا لفهم القائمة; لا شيء هنا مُقيَّم؛ هذا المشروع اختياري وغير مُقيَّم — راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة والنامية.
