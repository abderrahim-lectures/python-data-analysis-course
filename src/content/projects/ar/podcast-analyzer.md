...
يفترض هذا Python 101 — السلاسل، والمجموعات، وإدخال/إخراج الملفات، والدوال. لا شيء بعد ذلك. هذا اختياري وغير مُقيَّم؛ راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة.
