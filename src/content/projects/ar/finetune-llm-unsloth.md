...
هذا اختياري وغير مُقيَّم — خيار جيد بمجرد إنهاء مسار Python 101 الصعب (النموذج اللغوي المبني من الصفر يمنحك الحدس الذي يبني عليه هذا المشروع). راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة، التي تنمو باستمرار، بما في ذلك [مشروع وكيل الذكاء الاصطناعي](/docs/projects/ai-agent).
