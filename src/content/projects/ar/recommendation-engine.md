...
يفترض هذا Python 101 بالإضافة إلى معرفة عملية بـ`pandas` ورياضيات مصفوفات NumPy — وحدات تحليل البيانات في المساق. لا تعلم عميق، ولا أنظمة بمستوى صناعي. إنه اختياري وغير مصنّف؛ راجع [المشاريع الواقعية](/docs/projects) للقائمة الكاملة.
