...
يفترض هذا أساسيات Python وOOP متوسطًا ودراية HTTP كافية لمعرفة ما يفعله طلب POST — لا شيء من تحليل البيانات مطلوب. إنه اختياري وغير مصنّف؛ راجع [المشاريع الواقعية](/docs/projects) للقائمة الكاملة والمتنامية.
