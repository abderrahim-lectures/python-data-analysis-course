...
يفترض هذا أساسيات بايثون 101 — الإدخال/الإخراج للملفات والقواميس والدوال. لا خلفية تشفير مسبقة مطلوبة. إنه اختياري وغير مصنّف؛ راجع [المشاريع الواقعية](/docs/projects) للقائمة الكاملة.
