...
يفترض هذا إنهاء Python 101 — إدخال/إخراج الملفات، والسلاسل، والقواميس، والدوال. لا شيء أبعد من ذلك: لا أطر عمل، ولا قاعدة بيانات، ولا خدمات خارجية. هذا اختياري وغير مُقيَّم؛ راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة.
