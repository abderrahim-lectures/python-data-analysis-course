...
يفترض هذا إنهاء Python 101 وارتياحًا مع سير عمل CLI من [أدوات المطوّرين](/docs/projects). هذا اختياري وغير مُقيَّم؛ راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة.
