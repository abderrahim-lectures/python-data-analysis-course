...
هذا المشروع يفترض أنك تعرف أساسيات Python: المتغيّرات، الحلقات، الدوال، الفئات، والقواميس. كما يجب أن تكون مرتاحًا في فتح طرفية وتشغيل سكربتات Python من سطر الأوامر. هذا المشروع اختياري وغير مُقيَّم. راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة.
