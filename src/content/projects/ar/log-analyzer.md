...
يفترض هذا إنهاء Python 101 — إدخال/إخراج الملفات، والسلاسل، والقواميس، والدوال — زائد ارتياح طفيف مع قراءة إطارات DataFrame من تحليل البيانات. لا شيء أبعد من ذلك: لا أطر عمل، ولا واجهات API، ولا خدمات خارجية. هذا اختياري وغير مُقيَّم؛ راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة.
