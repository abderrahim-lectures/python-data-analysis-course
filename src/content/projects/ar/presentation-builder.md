...
يفترض هذا Python 101 — إدخال/إخراج الملفات، والسلاسل، والدوال. لا شيء بعده: لا إطار عمل JavaScript، ولا قاعدة بيانات، ولا أداة بناء. هذا اختياري وغير مُقيَّم؛ راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة.
