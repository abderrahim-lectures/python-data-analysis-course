...
هذا يفترض pandas وsklearn أساسيًا وبعض numpy. إنه مشروع اختياري غير مُقيَّم — راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة والنامية. يثبّت حزمتين (`pandas`, `scikit-learn`) — و`uv` يجعل ذلك سهلًا.
