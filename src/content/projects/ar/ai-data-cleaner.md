...
هذا يفترض إتمام Python 101 وأساسيات pandas من وحدة تحليل البيانات — لا شيء أبعد من ذلك. هذا اختياري وغير مُقيَّم؛ راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة والنامية.
...
- أطعم سجل التدقيق وحدة [تصوير البيانات](/docs/projects) في الدورة: اعرض مخطط أعمدة للمشاكل حسب العمود والاستراتيجية حتى يقرّ إنسان التعبئات في نظرة واحدة.
