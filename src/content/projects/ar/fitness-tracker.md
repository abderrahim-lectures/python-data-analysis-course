...
هذا يفترض أساسيات Python وأنسًا أساسيًا بالقوائم والقواميس — لا شيء من تحليل البيانات مطلوب. المشروع اختياري وغير مُقيَّم؛ راجع [مشاريع من العالم الحقيقي](/docs/projects) للاطلاع على القائمة الكاملة والمتنامية.
