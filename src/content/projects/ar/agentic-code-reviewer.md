...
هذا يفترض إنهاء Python 101 وإلمامًا كافيًا بـ git لمعرفة ما يعرضه `git diff` ، لا يُشترط أي شيء من تحليل البيانات. هذا اختياري وغير مُقيَّم؛ راجع [مشاريع من العالم الحقيقي](/ar/مشاريع) للاطلاع على القائمة الكاملة والنامية.
...
### 1.2 `subprocess.run([...], capture_output=True, text=True)` هو السطر الأساسي: تمرير الأمر كـ **ق...
...
### 2.1 نموذج لغوي بلا تعليمات سيُنتج بسعادة "يبدو جيدًا!" لكل شيء تقريبًا ، عديم الفائدة كمراجع. **...
...
### 3.1 اربط كود التقاط الفرق من الخطوة 1 وsystem prompt من الخطوة 2 معًا في مراجع يعمل فعليًا:
...
### 4.1 طريقتان واقعيتان لاستخدام هذه الأداة، تستحقان التجربة كلتاهما:
...
### 4.2 **2. راجِع التزامًا محددًا من تاريخ هذه الدورة نفسها** ، طريقة جيدة لرؤية الأداة تعمل على فر...
...
### 4.3 استنسخ أو افتح مستودع هذه الدورة، ثم وجّه الأداة إلى التزام حقيقي من الماضي:
...
### 4.4 يمكنك أيضًا مقارنة فرعك الحالي بفرع آخر، أو تمرير فرق مباشرة عبر أنبوب (pipe) بدلًا من ترك ا...
