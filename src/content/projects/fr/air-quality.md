...
Cela suppose les bases du travail avec des données ordonnées et rien de tout cela n'est noté ; c'est optionnel et non noté — voir [Projets du monde réel](/docs/projects) pour la liste complète et croissante.
