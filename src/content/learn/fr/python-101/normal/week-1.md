...
<span class="gamified-flourish">🐍 Chaque langage commence par nommer les choses. Cette semaine, vous découvrez la version Python de « soit $x$... ».</span>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>type(7 / 2)</code> est <code>float</code> — la division réelle (<code>/</code>) produit toujours un float en Python 3, même quand les deux opérandes sont des int et que le résultat est un nombre entier.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Oui : <code>"3" + "4"</code> est la chaîne <code>"34"</code> (concaténation), pas <code>7</code>. Additionner directement un <code>str</code> et un <code>int</code> (<code>"3" + 4</code>) lève une <code>TypeError</code> — il faut convertir d'abord.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Écrivez un petit programme : lisez un nom et une année de naissance avec deux appels à <code>input()</code>, convertissez l'année en <code>int</code>, soustrayez-la de l'année courante, et affichez une phrase avec une f-string, par ex. <code>{"f\"{name}, you are about {age} years old.\""}</code>.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> 15 // 4 vaut 3 (plancher de 3,75), et 15 % 4 vaut 3 (car 15 = 4·3 + 3). Ensemble, ils vérifient 15 = 4·(15 // 4) + (15 % 4), la même identité que l'algorithme de division que vous connaissez en théorie des nombres.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> int(-7.9) vaut -7 (tronque vers zéro — supprime la partie décimale), tandis que -7.9 // 1 vaut -8.0 (arrondit vers moins l'infini). Ils s'accordent pour les nombres positifs mais divergent pour les négatifs, exactement le piège dont avertit la section « Erreurs courantes » ci-dessus.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Étendez la calculatrice de pourboire : lisez une troisième entrée pour le nombre de personnes, convertissez-la en <code>int</code>, et divisez <code>total</code> par ce nombre pour obtenir <code>per_person</code>, affiché avec le format <code>:.2f</code> comme les autres montants.</p>
...
<div class="quiz" data-quiz="python-101-normal-week-1">
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">1. Quel est le type du résultat de 7 / 2 en Python 3 ?</p>
      ...
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">2. Que retourne toujours input(), quoi que l'utilisateur saisisse ?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">int</button>
        <button class="quiz-q__opt" data-idx="1">float</button>
        <button class="quiz-q__opt" data-idx="2">str</button>
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">3. Que vaut 17 % 5 ?</p>
        <div class="quiz-q__options">
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">4. Quel opérateur teste l'égalité (et non l'affectation) ?</p>
        <div class="quiz-q__options">
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">5. Que vaut int(4.9) ?</p>
        <div class="quiz-q__options">
        ...
        <button class="quiz-q__opt" data-idx="3">Une TypeError</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
