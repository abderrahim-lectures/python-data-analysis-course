...
<span class="gamified-flourish">📦 Une variable contient une valeur. Cette semaine, une variable contient toute une collection.</span>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> [grade for grade in grades if grade &gt;= 60] — une compréhension de liste filtrant avec une condition, la forme code de {'{'}g ∈ grades : g ≥ 60{'}'}.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Parcourez les mots, et pour chacun exécutez <code>counts[word] = counts.get(word, 0) + 1</code> — c'est une table de fréquences, la même structure sur laquelle s'appuie le parcours Difficile en Semaine 2.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Convertissez les deux listes en ensembles et utilisez la différence d'ensembles : <code>set(roster_a) - set(roster_b)</code> donne les étudiants dans A mais pas dans B.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Les tuples sont le bon choix : une paire de coordonnées ne devrait pas être modifiée en place, et sa forme fixe à deux éléments correspond mieux à la nature de forme fixe d'un tuple qu'à une list, qui sous-entend "une séquence extensible".</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> {"{name: len(name) for name in ['Amina', 'Karim', 'Sara']}"} — une compréhension de dictionnaire associant chaque nom à sa propre longueur, par exemple {"{'Amina': 5, 'Karim': 5, 'Sara': 4}"}.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Parcourez la liste de dictionnaires d'étudiants, et pour chacun calculez <code>sum(student["scores"]) / len(student["scores"])</code>, puis utilisez <code>max(...)</code> avec une fonction <code>key</code> (ou suivez manuellement le meilleur résultat courant) pour trouver l'étudiant dont la moyenne est la plus élevée.</p>
...
<div class="quiz" data-quiz="python-101-normal-week-3">
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">1. Que renvoie scores[1:3] pour scores = [10, 20, 30, 40, 50] ?</p>
      ...
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">2. Quel type de collection ne peut pas contenir de valeurs dupliquées ?</p>
        <div class="quiz-q__options">
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">3. Quelle est la manière la plus sûre de rechercher une clé qui pourrait ne pas exister dans un dict ?</p>
        <div class="quiz-q__options">
      ...
      <div class="quiz-q" data-answer="3">
        <p class="quiz-q__prompt">4. Quel type est immuable (ne peut pas être modifié après sa création) ?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">list</button>
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">5. Que renvoie scores.sort() ?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">La liste triée</button>
        <button class="quiz-q__opt" data-idx="1">None (elle trie en place)</button>
        <button class="quiz-q__opt" data-idx="2">Une nouvelle liste triée, l'originale inchangée</button>
        <button class="quiz-q__opt" data-idx="3">Le nombre d'éléments triés</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
