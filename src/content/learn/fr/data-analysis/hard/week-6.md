...
<span class="gamified-flourish">🕵️ L'analyse exploratoire des données (EDA) n'est pas « faire quelques graphiques ». C'est une façon disciplinée de poser des questions à un jeu de données avant de faire confiance à une quelconque conclusion qui en découle.</span>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>df["lunch"].value_counts()</code> — compte chaque catégorie distincte et sa fréquence d'apparition, triée par défaut de la plus à la moins courante.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Notez au moins 2 à 3 questions spécifiques en langage clair (par ex. « Le niveau d'éducation parentale est-il associé à reading_score ? ») avant d'écrire le moindre code pandas pour y répondre — la discipline est dans l'ordre, pas dans le code lui-même.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>df.groupby("parental_level_of_education")["writing_score"].agg(["mean", "count"])</code> — vérifier count à côté de mean révèle si la moyenne d'un groupe est basée sur trop peu de lignes pour être fiable.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Calculez Q1, Q3, et l'IQR pour reading_score de la même façon que l'exemple math_score, puis filtrez les valeurs hors de [Q1 - 1.5*IQR, Q3 + 1.5*IQR] et comptez combien de lignes qualifient.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Appelez df["test_preparation_course"].value_counts(normalize=True) pour obtenir la proportion ayant terminé contre n'ayant pas terminé la préparation au test, et multipliez par 100 (ou formatez en pourcentage) pour le lire comme un pourcentage.</p>
...
<div class="quiz" data-quiz="data-analysis-hard-week-6">
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">1. L'EDA se décrit le mieux comme :</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Construire un modèle prédictif le plus vite possible</button>
        <button class="quiz-q__opt" data-idx="1">Examiner systématiquement la structure et la qualité d'un jeu de données avant d'en tirer des conclusions</button>
        <button class="quiz-q__opt" data-idx="2">Faire autant de graphiques que possible</button>
        <button class="quiz-q__opt" data-idx="3">Nettoyer les données uniquement, sans analyse</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">2. Pour une colonne catégorielle, quelle méthode résume la distribution de ses catégories ?</p>
        <div class="quiz-q__options">
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">3. Pourquoi vérifier count à côté de mean en comparant des groupes ?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Ce n'est en fait pas utile</button>
        <button class="quiz-q__opt" data-idx="1">Une moyenne frappante basée sur très peu de lignes mérite moins de confiance</button>
        <button class="quiz-q__opt" data-idx="2">count est une syntaxe requise pour .groupby()</button>
        <button class="quiz-q__opt" data-idx="3">Cela convertit la moyenne en pourcentage</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">4. La leçon recommande de formuler les questions analytiques :</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Après avoir fait tous vos graphiques</button>
        <button class="quiz-q__opt" data-idx="1">Seulement à la toute fin du rapport</button>
        <button class="quiz-q__opt" data-idx="2">Avant de générer des graphiques, pour éviter de choisir rétroactivement des motifs &quot;intéressants&quot;</button>
        <button class="quiz-q__opt" data-idx="3">Le moment n'a pas d'importance</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">5. Une moyenne notablement supérieure à la médiane suggère :</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Une asymétrie à gauche (négative)</button>
        <button class="quiz-q__opt" data-idx="1">Une asymétrie à droite (positive)</button>
        <button class="quiz-q__opt" data-idx="2">Une distribution parfaitement symétrique</button>
        <button class="quiz-q__opt" data-idx="3">Rien — moyenne et médiane ne sont pas liées</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
