...
track: normal
week: 1
description: "الأسبوع 1: المتغيرات، الأنواع، والإدخال والإخراج — python-101 (normal track)."
---


# الأسبوع 1: المتغيرات، الأنواع، والإدخال والإخراج

<span class="gamified-flourish">🐍 كل لغة تبدأ بتسمية الأشياء. هذا الأسبوع، ستتعلم نسخة بايثون من "ليكن $x$...".</span>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>type(7 / 2)</code> هو <code>float</code> — القسمة الحقيقية (<code>/</code>) تُنتج دائمًا float في بايثون 3، حتى عندما يكون كلا الطرفين int والناتج عددًا صحيحًا.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> نعم: <code>"3" + "4"</code> هي السلسلة النصية <code>"34"</code> (دمج نصوص)، وليست <code>7</code>. جمع <code>str</code> و<code>int</code> مباشرة (<code>"3" + 4</code>) يرفع <code>TypeError</code> — يجب التحويل أولًا.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> اكتب برنامجًا صغيرًا: اقرأ اسمًا وسنة ميلاد باستخدام نداءين لـ <code>input()</code>، حوّل السنة إلى <code>int</code>، اطرحها من السنة الحالية، واطبع جملة باستخدام f-string، مثل <code>{"f\"{name}, you are about {age} years old.\""}</code>.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> 15 // 4 تساوي 3 (اقتطاع 3.75 للأسفل)، و15 % 4 تساوي 3 (لأن 15 = 4·3 + 3). معًا تحققان المتطابقة 15 = 4·(15 // 4) + (15 % 4)، وهي نفس متطابقة القسمة الإقليدية التي تعرفها من نظرية الأعداد.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> int(-7.9) تساوي -7 (اقتطاع نحو الصفر — تحذف الجزء العشري)، بينما -7.9 // 1 تساوي -8.0 (تقريب للأسفل نحو سالب اللانهاية). تتفقان مع الأعداد الموجبة لكنهما تختلفان مع السالبة، وهو بالضبط الخطأ الذي حذّر منه قسم "أخطاء شائعة" أعلاه.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> وسّع حاسبة الإكرامية: اقرأ إدخالًا ثالثًا لعدد الأشخاص، حوّله إلى <code>int</code>، واقسم <code>total</code> على هذا العدد للحصول على <code>per_person</code>، مطبوعًا بتنسيق <code>:.2f</code> مثل باقي المبالغ.</p>
...
<div class="quiz" data-quiz="python-101-normal-week-1">
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">1. ما نوع نتيجة 7 / 2 في بايثون 3؟</p>
      ...
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">2. ماذا تُعيد input() دائمًا، بغض النظر عمّا يكتبه المستخدم؟</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">int</button>
        <button class="quiz-q__opt" data-idx="1">float</button>
        <button class="quiz-q__opt" data-idx="2">str</button>
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">3. ما ناتج 17 % 5؟</p>
        <div class="quiz-q__options">
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">4. أي عامل يختبر المساواة (وليس الإسناد)؟</p>
        <div class="quiz-q__options">
      ...
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">5. ما ناتج int(4.9)؟</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">5</button>
        <button class="quiz-q__opt" data-idx="1">4</button>
        <button class="quiz-q__opt" data-idx="2">4.9</button>
        <button class="quiz-q__opt" data-idx="3">خطأ TypeError</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
