...
<span class="gamified-flourish">🔍 La semana pasada miraste la tabla completa. Esta semana aprendes a hacerle preguntas.</span>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>df[df["quiz1"] &gt;= 90]</code> — una máscara booleana que conserva solo las filas donde quiz1 es al menos 90.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>df[(df["quiz1"] &gt;= 60) &amp; (df["quiz2"] &gt;= 60) &amp; (df["quiz3"] &gt;= 60)]</code> — tres condiciones encadenadas combinadas con <code>&amp;</code>, cada una entre paréntesis.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>df.iloc[0:3]</code> selecciona las primeras tres filas por posición; <code>df.loc[0:3]</code> seleccionaría las filas etiquetadas 0, 1, 2 y 3 — cuatro filas — ya que el fin del slice de <code>.loc</code> es inclusivo.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>df[["name", "quiz1"]]</code> — corchetes dobles: los corchetes externos indexan el DataFrame, los corchetes internos son una lista de Python de nombres de columnas.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>df[df["name"].isin(["Amina", "Karim", "Sara"])]</code> — filtra solo las filas cuyo nombre coincide con uno de los tres valores dados.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> <code>df.loc[df["quiz1"] &lt; 60, ["name", "quiz1"]]</code> — combina una máscara booleana (filas) con una lista de columnas, en una sola llamada a .loc.</p>
...
<div class="quiz" data-quiz="data-analysis-normal-week-7">
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">1. ¿Qué operador combina dos máscaras booleanas en pandas (no el and/or de Python)?</p>
        ...
        <button class="quiz-q__opt" data-idx="3">ambos funcionan igual</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">2. .loc selecciona por:</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Solo posición</button>
        <button class="quiz-q__opt" data-idx="1">Etiqueta</button>
        <button class="quiz-q__opt" data-idx="2">Acceso aleatorio</button>
        <button class="quiz-q__opt" data-idx="3">Dtype de columna</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">3. df[df[&quot;score&quot;] &gt;= 60] funciona porque df[&quot;score&quot;] &gt;= 60 produce:</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Un único valor True/False</button>
        <button class="quiz-q__opt" data-idx="1">Una Series booleana, usada para filtrar filas</button>
        <button class="quiz-q__opt" data-idx="2">Un nuevo DataFrame con una columna</button>
        <button class="quiz-q__opt" data-idx="3">Un SyntaxError</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">4. df[[&quot;name&quot;, &quot;quiz1&quot;]] (corchetes dobles) devuelve:</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Una Series</button>
        <button class="quiz-q__opt" data-idx="1">Un DataFrame con esas dos columnas</button>
        <button class="quiz-q__opt" data-idx="2">Un único valor</button>
        <button class="quiz-q__opt" data-idx="3">Una lista de nombres de columnas</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">5. df[&quot;quiz1&quot;].between(60, 80) selecciona filas donde quiz1 está:</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Exactamente en 60 o exactamente en 80</button>
        <button class="quiz-q__opt" data-idx="1">Entre 60 y 80, inclusive</button>
        <button class="quiz-q__opt" data-idx="2">Solo mayor que 80</button>
        <button class="quiz-q__opt" data-idx="3">No es igual ni a 60 ni a 80</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
