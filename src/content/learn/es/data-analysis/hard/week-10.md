...
<span class="gamified-flourish">🏁 Todo de las Semanas 6 a 9 —el marco de trabajo, los gráficos univariados, el análisis de correlación, el pulido narrativo— converge en un solo informe esta semana.</span>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Usa <code>sns.relplot</code> o <code>sns.boxplot</code> con tanto <code>col="gender"</code> (o <code>hue="gender"</code>) como agrupando por <code>test_preparation_course</code>, siguiendo el patrón de facetado de la Semana 9, para ver si el efecto de la preparación del examen sobre las calificaciones se ve similar para ambos géneros o difiere.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Construye la matriz de correlación de 3 columnas y el mapa de calor exactamente como en la Semana 8, y luego escribe una interpretación corta señalando qué par se correlaciona más fuertemente y ofreciendo una explicación plausible de causa compartida (p. ej. preparación académica general) en lugar de afirmar que una calificación causa la otra.</p>
...
<p class="challenge__answer">💡 <strong>Answer:</strong> Una respuesta razonable señala al menos una limitación real, p. ej.: el dataset no registra cuándo/dónde se recolectó, así que los resultados podrían no generalizarse a otras escuelas, regiones o años; las "calificaciones de examen" como resultado capturan solo una medida estrecha del éxito educativo; y los tamaños de grupo para algunas categorías pueden ser lo bastante pequeños como para que los promedios lleven una incertidumbre real.</p>
...
<div class="quiz" data-quiz="data-analysis-hard-week-10">
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">1. df[[&quot;math_score&quot;,&quot;reading_score&quot;,&quot;writing_score&quot;]].mean(axis=1) calcula:</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">La media de cada columna por separado</button>
        <button class="quiz-q__opt" data-idx="1">Una media por fila a través de las tres columnas, un valor por estudiante</button>
        <button class="quiz-q__opt" data-idx="2">La media general de todo el DataFrame</button>
        <button class="quiz-q__opt" data-idx="3">Una matriz de correlación</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">2. La conclusión de un informe de EDA riguroso debería:</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Presentar los hallazgos como hechos probados sin advertencias</button>
        <button class="quiz-q__opt" data-idx="1">Incluir hallazgos, nivel de confianza y explicaciones alternativas plausibles</button>
        <button class="quiz-q__opt" data-idx="2">Incluir solo gráficos, sin interpretación escrita</button>
        <button class="quiz-q__opt" data-idx="3">Evitar mencionar los tamaños de muestra</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">3. ¿Cuál de estos NO es algo que este dataset pueda respaldar, según la lección?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Asociaciones entre la preparación del examen y las calificaciones</button>
        <button class="quiz-q__opt" data-idx="1">Una descripción de las distribuciones de calificación</button>
        <button class="quiz-q__opt" data-idx="2">Una afirmación causal de que la preparación del examen causa directamente calificaciones más altas</button>
        <button class="quiz-q__opt" data-idx="3">Una comparación de calificaciones promedio entre categorías</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="1">
        <p class="quiz-q__prompt">4. El entregable requerido esta semana debe incluir como mínimo:</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Solo un mapa de calor de correlación</button>
        <button class="quiz-q__opt" data-idx="1">Perfil del dataset, preguntas formuladas, análisis de correlación, un gráfico narrativo y conclusiones escritas</button>
        <button class="quiz-q__opt" data-idx="2">Un modelo de aprendizaje automático entrenado con los datos</button>
        <button class="quiz-q__opt" data-idx="3">Solo la salida cruda de pandas sin interpretación</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
      <div class="quiz-q" data-answer="2">
        <p class="quiz-q__prompt">5. Según la lección, ¿cuándo deberías comprobar el tamaño de muestra (count) por grupo?</p>
        <div class="quiz-q__options">
        <button class="quiz-q__opt" data-idx="0">Solo para el gráfico final</button>
        <button class="quiz-q__opt" data-idx="1">Nunca — la media sola siempre es suficiente</button>
        <button class="quiz-q__opt" data-idx="2">Cada vez que compares medias de grupo, ya que los grupos pequeños merecen menos confianza</button>
        <button class="quiz-q__opt" data-idx="3">Solo si el dataset tiene valores faltantes</button>
        </div>
        <p class="quiz-q__feedback" hidden></p>
      </div>
